...
while len(s1) != 0:
    ...
    if op in ops:
        ...
        if op in ('|', '@'):
            #ifdef python3
            if doStackOutput:
                print("({0}, {1})".format(v1.a, v1.b))
                print(op)
                print(' = ')
                print("{0}".format(v3.a))
            else:
                print("({0}, {1})".format(v1.a, v1.b) + ' ' + op + ' = ' + v3.a)
            #ifdef python2
#            if doStackOutput:
...
#                print (formatV % (v1.a, v1.b) + ' ' + op + ' = ' + v3.a)
            ...
            if complexformat:      # use complex notation
                #ifdef python3
                if doStackOutput:
                    print("{0}  {1}i {2}".format(v1.a, sign(v1.b), v1.b)
                    print(op)
                    print("{0}  {1}i {2}".format(v2.a, sign(v2.b), v2.b)
                    print(' = ')
                    print("{0}  {1}i {2}".format(v3.a, sign(v3.b), v3.b)
                else:
